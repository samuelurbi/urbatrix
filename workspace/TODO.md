...
<todo id="mobile-nav-qa">
QA de navegación móvil en dispositivos reales
Verificar apertura/cierre, focus order y cierre con Escape del menú hamburger en iOS Safari y Chrome Android.
</todo>

<todo id="font-fallback-validation">
Validar fallback tipográfico Mont → Montserrat
Comprobar en navegador sin Mont cargada que textos mantienen pesos 400/600/700 con Montserrat.
</todo>

<todo id="figma-visual-validation">
Validar UI final contra Figma importado (paso 5)
Comparar spacing, jerarquía, botones y micro-alineaciones cuando el Figma esté disponible/reimportado en workspace.
</todo>

<todo id="copy-cleanup-typos">
Corregir typos de contenido en textos públicos
Ajustar errores como “cinca”, “sair”, “WhtasApp”, “Paises”, “Bilingue”, “GDRP”.
</todo>
